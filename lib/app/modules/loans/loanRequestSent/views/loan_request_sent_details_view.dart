  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const AppBarWidgetTitle(
          title: AppStrings.LOAN_REQUEST_DETAIL,
        ),
        body: FutureDataBuilder<LoanRequestModel>(
          future: () async {
            ...
            if (Get.arguments['loan_id'] != null) {
              return Get.find<LoanRequestSentController>()
                  .getMyLoanRequest(Get.arguments['loan_id']);
            }
            return null;
          },
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    lableWidget(
                        lbl: "Amount", val: "${(data.amount ?? 0)} EHTG"),
                    //     val:
                    //         "${(myLoanRequestDetailController.myLoanRequestDetail.amount ?? 0)} EHTG"),
                    SizedBox(height: 8.ss),
                    lableWidget(
                    ...
                    if (data.status == LoanStatus.requested) ...[
                      ...
                      Center(
                        child: DaiLogButtonPrimary(
                          ...
                          onTap: () {
                            Get.to<bool>(LoanRequestOffersView(data.id!))
