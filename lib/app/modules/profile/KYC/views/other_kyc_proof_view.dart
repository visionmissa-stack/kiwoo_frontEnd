...
class OtherKycProofView extends GetView<OtherKycProofController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidgetTitle(title: _pageTitle),
      body: Form(
          ...
          children: [
            if (_pageTitle == AppStrings.ADDRESS) ...[
              ...
              inputWithLabel(
                ...
                validator: (value) => isEmptyValidator(value, _emptyValidator),
              ),
              verticalSpaceMedium,
              //city
              inputWithLabel(
                ...
                validator: (value) =>
                    isEmptyValidator(value, AppStrings.PLS_ENTER_ZIPCODE),
              ),
              verticalSpaceMedium,
              //state
              inputWithLabel(
                ...
                validator: (value) =>
                    isEmptyValidator(value, AppStrings.PLS_ENTER_STATE),
              ),
              verticalSpaceMedium,
              //country
              inputWithLabel(
                ...
                validator: (value) =>
                    isEmptyValidator(value, AppStrings.PLS_ENTER_COUNTRY),
              ),
              verticalSpaceMedium,
              //zipcode
              inputWithLabel(
            ...
            AppButton(
              ...
              onTap: () {
                if (controller.formKey.currentState?.validate() == true) {
                  ...
                  showOverlay(
                    asyncFunction: () =>
                        controller.updateDocuments(_label.toLowerCase(), _url),
                  );
                }
              },
            ),
